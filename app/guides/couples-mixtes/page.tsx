    ...
    <div style={{ position: 'relative', zIndex: 2, minHeight: '100vh' }}>
      ...
      <section className={styles.section} style={{ paddingTop: 20 }}>
        <div className={styles.offersHeader}>
          <div className={styles.sectionLabel} style={{ justifyContent: 'center' }}>
            Guide PDF · Couples mixtes &amp; interculturels
          </div>
          <h1 className={`${styles.sectionTitle} reveal`} style={{ textAlign: 'center', margin: '0 auto 28px' }}>
            Couples mixtes &amp; interculturels —<br />
            <em>4 approches</em>
          </h1>
          <p className={`${styles.sectionLead} reveal`} style={{ textAlign: 'center', margin: '0 auto 20px', maxWidth: 560 }}>
            S&apos;aimer à travers la différence, c&apos;est beau — et parfois épuisant.
            Seul·e ou à deux, ce guide t&apos;accompagne à travers 4 regards TCC pour transformer
            ce qui divise en richesse partagée, et construire une relation interculturelle solide et apaisée.
          </p>
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
            {[
              {
                n: '01',
                title: 'Ce que chacun apporte sans le savoir',
                desc: 'Identifier les héritages culturels invisibles — valeurs, réflexes, attentes — qui façonnent la relation sans qu\'on en soit conscient.',
              },
              {
                n: '02',
                title: 'Quand « différent » devient « menace »',
                desc: 'Déconstruire les réflexes de rejet et de surinterprétation pour transformer la friction culturelle en dialogue.',
              },
              {
                n: '03',
                title: 'Deux mondes, une rencontre',
                desc: 'Créer un espace commun et des rituels partagés sans effacer ce qu\'on est chacun — un couple qui se construit, pas qui se fusionne.',
              },
              {
                n: '04',
                title: 'Les deux familles dans le salon',
                desc: 'Naviguer les attentes, les regards et les pressions extérieures — apprendre à tenir ensemble face aux deux côtés.',
              },
            ].map((item) => (
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.65, fontWeight: 300 }}>
              Exercices à faire seul·e ou à deux — pour ancrer les prises de conscience et avancer concrètement, à votre rythme.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ textAlign: 'center', padding: 'clamp(40px, 8vw, 80px) 24px' }}>
        <p style={{
          ...
          « La différence n&apos;est pas un obstacle. C&apos;est le matériau de votre relation. »
        </p>
        <BuyButtonCouplesMixtes />
