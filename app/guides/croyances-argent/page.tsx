...
export const metadata: Metadata = {
  title: "Guide Croyances sur l'argent — 4 approches TCC",
  description:
    "Identifier les héritages limitants sur l'argent, les restructurer et construire un rapport sain aux finances : 4 approches TCC concrètes.",
};
    ...
    <div style={{ position: 'relative', zIndex: 2, minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: 80, paddingBottom: 0, textAlign: 'center' }}>
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '0 24px 48px' }}>
          ...
          <GuideBuyButton guideId="croyances-argent" />
      ...
      <section className={styles.section} style={{ paddingTop: 20 }}>
        <div className={styles.offersHeader}>
          <div className={styles.sectionLabel} style={{ justifyContent: 'center' }}>
            Guide PDF · Croyances sur l&apos;argent
          </div>
          <h1 className={`${styles.sectionTitle} reveal`} style={{ textAlign: 'center', margin: '0 auto 28px' }}>
            Croyances sur l&apos;argent —<br />
            <em>4 approches</em>
          </h1>
          <p className={`${styles.sectionLead} reveal`} style={{ textAlign: 'center', margin: '0 auto 20px', maxWidth: 560 }}>
            Tes croyances sur l&apos;argent ont été formées bien avant tes premiers euros — dans ta famille,
            ta culture, ta communauté. Ce guide t&apos;accompagne à travers 4 regards TCC pour identifier
            ces héritages limitants, les restructurer et construire un rapport sain à l&apos;argent.
          </p>
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
            {[
              {
                n: '01',
                title: 'Tes croyances héritées',
                desc: "Identifier les messages reçus sur l'argent dans ta famille, ta culture et ta communauté.",
              },
              {
                n: '02',
                title: 'Les pensées qui te limitent',
                desc: "Repérer les distorsions cognitives qui sabotent ta relation à l'argent et les reformuler.",
              },
              {
                n: '03',
                title: "Ton rapport sain à l'argent",
                desc: "Construire une relation à l'argent qui reflète tes valeurs, pas tes peurs héritées.",
              },
              {
                n: '04',
                title: 'Argent, famille & milieu',
                desc: "Naviguer les tensions entre ton évolution financière et tes origines sans culpabilité.",
              },
            ].map((item) => (
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.65, fontWeight: 300 }}>
              Espaces guidés pour transformer ta relation à l&apos;argent, pas à pas.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ textAlign: 'center', padding: 'clamp(40px, 8vw, 80px) 24px' }}>
        <p style={{
          ...
          « L&apos;argent est un outil — pas une punition ni une récompense. Il peut être neutre. »
        </p>
        <GuideBuyButton guideId="croyances-argent" />
