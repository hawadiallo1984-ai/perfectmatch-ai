...
export const metadata: Metadata = {
  title: 'Guide Foi, identité & bien-être — 4 approches TCC',
  description:
    "Distinguer ce qui vient de toi de ce qui t'a été imposé, gérer la culpabilité religieuse et habiter une spiritualité qui te ressemble : 4 approches TCC concrètes.",
};
    ...
    <div style={{ position: 'relative', zIndex: 2, minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: 80, paddingBottom: 0, textAlign: 'center' }}>
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '0 24px 48px' }}>
          ...
          <GuideBuyButton guideId="foi-identite-bien-etre" />
      ...
      <section className={styles.section} style={{ paddingTop: 20 }}>
        <div className={styles.offersHeader}>
          <div className={styles.sectionLabel} style={{ justifyContent: 'center' }}>
            Guide PDF · Foi, identité &amp; bien-être
          </div>
          <h1 className={`${styles.sectionTitle} reveal`} style={{ textAlign: 'center', margin: '0 auto 28px' }}>
            Foi, identité &amp; bien-être —<br />
            <em>4 approches</em>
          </h1>
          <p className={`${styles.sectionLead} reveal`} style={{ textAlign: 'center', margin: '0 auto 20px', maxWidth: 560 }}>
            Ta foi a façonné qui tu es — mais entre les injonctions religieuses, la culpabilité héritée
            et les tensions avec ta vie actuelle, il est parfois difficile de savoir ce qui vient vraiment de toi.
            Ce guide t&apos;accompagne à travers 4 regards TCC pour habiter une spiritualité à ta mesure.
          </p>
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
            {[
              {
                n: '01',
                title: 'Ce que la foi a déposé en toi',
                desc: "Explorer les messages, valeurs et injonctions issus de ta pratique religieuse et comprendre leur impact sur ton rapport à toi-même.",
              },
              {
                n: '02',
                title: 'La culpabilité et les pensées rigides',
                desc: "Identifier les distorsions cognitives d'origine religieuse et les restructurer sans renier ta foi.",
              },
              {
                n: '03',
                title: 'Ta foi, ton chemin',
                desc: "Distinguer ce qui vient de toi de ce qui t'a été imposé, et définir une spiritualité qui te ressemble.",
              },
              {
                n: '04',
                title: 'Foi, famille & modernité',
                desc: "Naviguer les tensions entre tes croyances, tes proches et les exigences de ta vie actuelle.",
              },
            ].map((item) => (
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.65, fontWeight: 300 }}>
              Espaces guidés pour clarifier ta spiritualité, nommer les héritages et avancer à ton propre rythme.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ textAlign: 'center', padding: 'clamp(40px, 8vw, 80px) 24px' }}>
        <p style={{
          ...
          « Ta foi t&apos;appartient. Tu peux la vivre à ta façon, sans honte ni justification. »
        </p>
        <GuideBuyButton guideId="foi-identite-bien-etre" />
