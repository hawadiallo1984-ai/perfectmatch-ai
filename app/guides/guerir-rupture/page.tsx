...
import BuyButtonRupture from './BuyButtonRupture';

export const metadata: Metadata = {
  title: "Guide Guérir d'une rupture — 4 approches TCC",
  description:
    "Traverser la douleur d'une rupture, sortir de la rumination et te retrouver : un guide PDF de 4 approches TCC pour reconstruire après une séparation.",
};
    ...
    <div style={{ position: 'relative', zIndex: 2, minHeight: '100vh' }}>
      ...
      <section className={styles.section} style={{ paddingTop: 20 }}>
        <div className={styles.offersHeader}>
          <div className={styles.sectionLabel} style={{ justifyContent: 'center' }}>
            Guide PDF · Guérir d&apos;une rupture
          </div>
          <h1 className={`${styles.sectionTitle} reveal`} style={{ textAlign: 'center', margin: '0 auto 28px' }}>
            Guérir d&apos;une rupture —<br />
            <em>4 approches</em>
          </h1>
          <p className={`${styles.sectionLead} reveal`} style={{ textAlign: 'center', margin: '0 auto 20px', maxWidth: 560 }}>
            Une rupture ne fait pas que perdre quelqu&apos;un — elle remet en question qui on est.
            Ce guide t&apos;accompagne à travers 4 regards TCC pour traverser la douleur,
            sortir de la rumination et te retrouver — à ton rythme, sans te forcer.
          </p>
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
            {[
              {
                n: '01',
                title: 'Pourquoi ça fait si mal',
                desc: "Comprendre ce que la rupture active vraiment sur le plan psychologique — le deuil, l'identité, l'attachement — pour sortir de la sidération.",
              },
              {
                n: '02',
                title: 'Sortir de la rumination',
                desc: "Identifier les pensées qui entretiennent la souffrance — idéalisation, regrets, scénarios — et les interrompre avec des outils TCC concrets.",
              },
              {
                n: '03',
                title: 'Te retrouver',
                desc: "Reconnecter avec ton identité propre, en dehors de la relation perdue — redécouvrir ce qui compte pour toi, hors du couple.",
              },
              {
                n: '04',
                title: 'Reconstruire ton monde',
                desc: "Réinvestir ta vie, tes liens et ton avenir sans te fermer à la suite — avancer sans trahir ce que tu as vécu.",
              },
            ].map((item) => (
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.65, fontWeight: 300 }}>
              Espaces de deuil guidés et exercices de reconstruction pas à pas — pour avancer concrètement, sans te brusquer.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ textAlign: 'center', padding: 'clamp(40px, 8vw, 80px) 24px' }}>
        <p style={{
          ...
          « On ne guérit pas d&apos;une rupture en l&apos;oubliant. On guérit en se retrouvant. »
        </p>
        <BuyButtonRupture />
