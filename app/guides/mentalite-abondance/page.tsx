...
export const metadata: Metadata = {
  title: "Guide Mentalité d'abondance — 4 approches TCC",
  description:
    "Comprendre les racines du manque, cultiver l'abondance intérieure et modifier ton environnement : 4 approches TCC concrètes.",
};
    ...
    <div style={{ position: 'relative', zIndex: 2, minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: 80, paddingBottom: 0, textAlign: 'center' }}>
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '0 24px 48px' }}>
          ...
          <GuideBuyButton guideId="mentalite-abondance" />
      ...
      <section className={styles.section} style={{ paddingTop: 20 }}>
        <div className={styles.offersHeader}>
          <div className={styles.sectionLabel} style={{ justifyContent: 'center' }}>
            Guide PDF · Mentalité d&apos;abondance
          </div>
          <h1 className={`${styles.sectionTitle} reveal`} style={{ textAlign: 'center', margin: '0 auto 28px' }}>
            Mentalité d&apos;abondance —<br />
            <em>4 approches</em>
          </h1>
          <p className={`${styles.sectionLead} reveal`} style={{ textAlign: 'center', margin: '0 auto 20px', maxWidth: 560 }}>
            La mentalité de rareté s&apos;apprend — et peut se défaire.
            Ce guide t&apos;accompagne à travers 4 regards TCC pour comprendre les racines du manque,
            cultiver une abondance intérieure réelle et modifier les dynamiques qui alimentent la rareté.
          </p>
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
            {[
              {
                n: '01',
                title: 'Les racines de la rareté',
                desc: "Comprendre d'où vient la mentalité de manque et comment elle s'est installée dans ton rapport à la vie.",
              },
              {
                n: '02',
                title: 'Sortir des pensées de manque',
                desc: "Identifier les croyances limitantes de rareté et les restructurer vers plus d'abondance.",
              },
              {
                n: '03',
                title: "Cultiver l'abondance intérieure",
                desc: "Développer un rapport à la vie basé sur la gratitude, la confiance et la réciprocité.",
              },
              {
                n: '04',
                title: "Ton environnement et l'abondance",
                desc: "Repérer et modifier les dynamiques extérieures — personnes, contextes — qui alimentent la rareté.",
              },
            ].map((item) => (
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.65, fontWeight: 300 }}>
              Pratiques quotidiennes pour ancrer une nouvelle relation à l&apos;abondance durablement.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ textAlign: 'center', padding: 'clamp(40px, 8vw, 80px) 24px' }}>
        <p style={{
          ...
          « Il n&apos;y a pas de manque à l&apos;intérieur que l&apos;extérieur peut combler — et inversement. »
        </p>
        <GuideBuyButton guideId="mentalite-abondance" />
