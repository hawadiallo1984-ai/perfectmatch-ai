...
export const metadata: Metadata = {
  title: 'Guide Misogynoir — 4 approches TCC',
  description:
    "Nommer, déconstruire et dépasser les effets de la misogynoir sur ton image de toi-même : 4 approches TCC pour affirmer ton droit d'être pleinement toi.",
};
    ...
    <div style={{ position: 'relative', zIndex: 2, minHeight: '100vh' }}>
      ...
      <section style={{ paddingTop: 80, paddingBottom: 0, textAlign: 'center' }}>
        <div style={{ maxWidth: 640, margin: '0 auto', padding: '0 24px 48px' }}>
          ...
          <GuideBuyButton guideId="misogynoir" />
      ...
      <section className={styles.section} style={{ paddingTop: 20 }}>
        <div className={styles.offersHeader}>
          ...
          <p className={`${styles.sectionLead} reveal`} style={{ textAlign: 'center', margin: '0 auto 20px', maxWidth: 560 }}>
            La misogynoir — cette violence croisée du racisme et du sexisme — laisse des traces profondes sur ton image de toi-même,
            tes relations et ta place dans le monde. Ce guide t&apos;accompagne à travers 4 regards TCC
            pour les nommer, les déconstruire et affirmer ton droit d&apos;être pleinement toi.
          </p>
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
            {[
              {
                n: '01',
                title: 'Ce que la misogynoir a déposé en toi',
                desc: "Comprendre comment le racisme genré a façonné ton image de toi-même et influencé tes relations.",
              },
              {
                n: '02',
                title: 'Quand les stéréotypes parlent à ta place',
                desc: "Identifier les pensées automatiques issues de la misogynoir et les déconstruire avec des outils TCC concrets.",
              },
              {
                n: '03',
                title: "Ton droit d'être pleinement toi",
                desc: "Affirmer ton identité au-delà des projections racistes et sexistes, et reconstruire une image de toi libre du regard extérieur.",
              },
              {
                n: '04',
                title: "Te protéger & t'entourer",
                desc: "Construire des espaces de sécurité et identifier un entourage qui te reconnaît et te soutient vraiment.",
              },
            ].map((item) => (
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.65, fontWeight: 300 }}>
              Espaces de réflexion et d&apos;affirmation identitaire guidés pour avancer à ton propre rythme.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ textAlign: 'center', padding: 'clamp(40px, 8vw, 80px) 24px' }}>
        <p style={{
          ...
          « Tu n&apos;es pas ce qu&apos;on projette sur toi. Tu es bien plus que ça. »
        </p>
        <GuideBuyButton guideId="misogynoir" />
