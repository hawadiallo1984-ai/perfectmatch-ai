    ...
    <div style={{ position: 'relative', zIndex: 2, minHeight: '100vh' }}>
      ...
      <section className={styles.section} style={{ paddingTop: 20 }}>
        <div className={styles.offersHeader}>
          ...
          <p className={`${styles.sectionLead} reveal`} style={{ textAlign: 'center', margin: '0 auto 20px', maxWidth: 560 }}>
            Entre hypersexualisation, tabous communautaires et regard racial, ta sexualité a grandi dans un terrain chargé.
            Ce guide t&apos;accompagne à travers 4 regards TCC pour distinguer ce qui vient de toi et ce que le monde a déposé —
            et habiter ton désir en terrain propre.
          </p>
        ...
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
            {[
              {
                n: '01',
                title: 'L\'hypersexualisation et ses effets',
                desc: 'Comprendre comment le regard extérieur s\'est infiltré dans ton rapport à toi-même — et comment il continue de peser sur tes choix et ton désir.',
              },
              {
                n: '02',
                title: 'Les tabous internes',
                desc: 'Déconstruire les silences et injonctions sur la sexualité dans les communautés noires — ce qu\'on ne dit pas, ce qu\'on porte seul·e.',
              },
              {
                n: '03',
                title: 'Désirer et être désiré·e',
                desc: 'Différencier désir authentique et performance imposée par le regard racial — retrouver ce qui vient vraiment de soi.',
              },
              {
                n: '04',
                title: 'Habiter sa sexualité en terrain propre',
                desc: 'Construire une relation à soi libre du regard racial — des outils concrets pour affirmer son désir sans avoir à le justifier.',
              },
            ].map((item) => (
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, opacity: 0.7, lineHeight: 1.65, fontWeight: 300 }}>
              Espaces de réflexion et exercices d&apos;affirmation identitaire — pour ancrer ce travail dans ta réalité concrète.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ textAlign: 'center', padding: 'clamp(40px, 8vw, 80px) 24px' }}>
        <p style={{
          ...
          « Ton désir n&apos;a pas à porter le poids de ce qu&apos;on a projeté sur toi. Il peut être à toi, pleinement. »
        </p>
        <BuyButton />
