...
export const DESIR_RESULTS: Record<DesirProfile, {
  ...
  "desir-en-veille": {
    ...
    guideIds: ["communiquer-desirs-limites", "plaisir-feminin-orgasme", "preliminaires-et-lenteur", "raviver-le-desir"],
  ...
  "sous-pression": {
    ...
    guideIds: ["communiquer-desirs-limites", "preliminaires-et-lenteur", "anxiete-performance-sexuelle-homme", "depasser-injonctions-virilite"],
    packId: "pack-intimite-sexualite",
  },
  "pudeur-blocage": {
    ...
    guideIds: ["communiquer-desirs-limites", "plaisir-feminin-orgasme", "depasser-honte-blocages-sexuels", "explorer-ses-fantasmes"],
    packId: "pack-intimite-sexualite",
  },
  "quete-connexion": {
    ...
    guideIds: ["communiquer-desirs-limites", "preliminaires-et-lenteur", "raviver-le-desir", "desirs-desaccordes"],
    packId: "pack-intimite-sexualite",
  },
};
