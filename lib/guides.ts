...
import { PRO_GUIDES_13 } from './proGuides13';
import { PRO_GUIDES_14 } from './proGuides14';
import { PRO_GUIDES_15 } from './proGuides15';
import { PRO_GUIDES_16 } from './proGuides16';
import { PRO_GUIDES_17 } from './proGuides17';
import { PRO_GUIDES_18 } from './proGuides18';
import { PRO_GUIDES_19 } from './proGuides19';
import { PRO_GUIDES_20 } from './proGuides20';
import { PRO_GUIDES_21 } from './proGuides21';
import { PRO_GUIDES_22 } from './proGuides22';
...
import { PRO_GUIDES_27 } from './proGuides27';
import { PRO_GUIDES_28 } from './proGuides28';
import { PRO_GUIDES_29 } from './proGuides29';
import { PRO_GUIDES_30 } from './proGuides30';
import { PRO_GUIDES_32 } from './proGuides32';
import { PRO_GUIDES_33 } from './proGuides33';
import { PRO_GUIDES_34 } from './proGuides34';
import { PRO_GUIDES_35 } from './proGuides35';
...
const _pro13_mapped = Object.fromEntries(
  PRO_GUIDES_13
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro14_mapped = Object.fromEntries(
  PRO_GUIDES_14
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro15_mapped = Object.fromEntries(
  PRO_GUIDES_15
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro16_mapped = Object.fromEntries(
  PRO_GUIDES_16
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro17_mapped = Object.fromEntries(
  PRO_GUIDES_17
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro18_mapped = Object.fromEntries(
  PRO_GUIDES_18
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro19_mapped = Object.fromEntries(
  PRO_GUIDES_19
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro20_mapped = Object.fromEntries(
  PRO_GUIDES_20
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro21_mapped = Object.fromEntries(
  PRO_GUIDES_21
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro22_mapped = Object.fromEntries(
  PRO_GUIDES_22
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro23_mapped = Object.fromEntries(
  PRO_GUIDES_23
...
const _pro24_mapped = Object.fromEntries(
  PRO_GUIDES_24
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro25_mapped = Object.fromEntries(
  PRO_GUIDES_25
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro27_mapped = Object.fromEntries(
  PRO_GUIDES_27
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro28_mapped = Object.fromEntries(
  PRO_GUIDES_28
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro29_mapped = Object.fromEntries(
  PRO_GUIDES_29
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped) && !(g.id in _pro28_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro30_mapped = Object.fromEntries(
  PRO_GUIDES_30
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped) && !(g.id in _pro28_mapped) && !(g.id in _pro29_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro32_mapped = Object.fromEntries(
  PRO_GUIDES_32
...
const _pro33_mapped = Object.fromEntries(
  PRO_GUIDES_33
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped) && !(g.id in _pro28_mapped) && !(g.id in _pro29_mapped) && !(g.id in _pro30_mapped) && !(g.id in _pro32_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro34_mapped = Object.fromEntries(
  PRO_GUIDES_34
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped) && !(g.id in _pro28_mapped) && !(g.id in _pro29_mapped) && !(g.id in _pro30_mapped) && !(g.id in _pro32_mapped) && !(g.id in _pro33_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro35_mapped = Object.fromEntries(
  PRO_GUIDES_35
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped) && !(g.id in _pro28_mapped) && !(g.id in _pro29_mapped) && !(g.id in _pro30_mapped) && !(g.id in _pro32_mapped) && !(g.id in _pro33_mapped) && !(g.id in _pro34_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro36_mapped = Object.fromEntries(
  PRO_GUIDES_36
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped) && !(g.id in _pro28_mapped) && !(g.id in _pro29_mapped) && !(g.id in _pro30_mapped) && !(g.id in _pro32_mapped) && !(g.id in _pro33_mapped) && !(g.id in _pro34_mapped) && !(g.id in _pro35_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro37_mapped = Object.fromEntries(
  PRO_GUIDES_37
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped) && !(g.id in _pro28_mapped) && !(g.id in _pro29_mapped) && !(g.id in _pro30_mapped) && !(g.id in _pro32_mapped) && !(g.id in _pro33_mapped) && !(g.id in _pro34_mapped) && !(g.id in _pro35_mapped) && !(g.id in _pro36_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
...
const _pro38_mapped = Object.fromEntries(
  PRO_GUIDES_38
    .filter(g => !(g.id in _base) && !(g.id in _mapped) && !(g.id in _extra) && !(g.id in _new_mapped) && !(g.id in _pro_mapped) && !(g.id in _pro2_mapped) && !(g.id in _pro3_mapped) && !(g.id in _pro4_mapped) && !(g.id in _pro5_mapped) && !(g.id in _pro6_mapped) && !(g.id in _pro7_mapped) && !(g.id in _pro8_mapped) && !(g.id in _pro9_mapped) && !(g.id in _pro10_mapped) && !(g.id in _pro11_mapped) && !(g.id in _pro12_mapped) && !(g.id in _pro13_mapped) && !(g.id in _pro14_mapped) && !(g.id in _pro15_mapped) && !(g.id in _pro16_mapped) && !(g.id in _pro17_mapped) && !(g.id in _pro18_mapped) && !(g.id in _pro19_mapped) && !(g.id in _pro20_mapped) && !(g.id in _pro21_mapped) && !(g.id in _pro22_mapped) && !(g.id in _pro23_mapped) && !(g.id in _pro24_mapped) && !(g.id in _pro25_mapped) && !(g.id in _pro26_mapped) && !(g.id in _pro27_mapped) && !(g.id in _pro28_mapped) && !(g.id in _pro29_mapped) && !(g.id in _pro30_mapped) && !(g.id in _pro32_mapped) && !(g.id in _pro33_mapped) && !(g.id in _pro34_mapped) && !(g.id in _pro35_mapped) && !(g.id in _pro36_mapped) && !(g.id in _pro37_mapped))
    .map(g => [g.id, {
      id: g.id,
      name: g.title,
      priceCents: g.priceCents,
